...
\begin{figure}[H]
    \centering
        ...
        \caption{f0.5 en función de altura de árbol}
...
\end{enumerate}
	En el gráfico ~\ref{fig:knn_f05_en_funcion_vecinos} se observan los resultados del clasificador corriendo con los mejores atributos de Peso y Métrica de distancia que encontramos para este problema.
...
El clasificador con los parametros por defecto contiene como características principales un Kernel de Base Radial \footnote{\url{https://en.wikipedia.org/wiki/Radial_basis_function_kernel}} con parametro gamma = 1/numero\_de\_features y la heuristica llamada \textit{Shrinking} la cual permite computar los cálculos del Kernel de forma mas rápida.
